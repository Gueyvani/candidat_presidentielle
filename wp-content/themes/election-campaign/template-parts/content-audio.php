...
<?php
  ...
  $election_campaign_audio = false;

  // Only get audio from the content if a playlist isn't present.
  if ( false === strpos( $election_campaign_content, 'wp-playlist-script' ) ) {
    $election_campaign_audio = get_media_embedded_in_content( $election_campaign_content, array( 'audio' ) );
  }
?>
  ...
  <div class="box-image">
    <?php
      if ( ! is_single() ) {
        ...
        if ( ! empty( $election_campaign_audio ) ) {
          foreach ( $election_campaign_audio as $election_campaign_audio_html ) {
            echo '<div class="entry-audio">';
              echo $election_campaign_audio_html;
