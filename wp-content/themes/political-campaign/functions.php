...
function political_campaign_activation_notice() {
	...
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/political-campaign-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'political-campaign' ) .'</a></span>';
	echo '</div>';
}
...
define('POLITICAL_CAMPAIGN_BUY_NOW',__('https://www.vwthemes.com/products/political-campaign-wordpress-theme/','political-campaign'));
...
define('POLITICAL_CAMPAIGN_CREDIT',__('https://www.vwthemes.com/products/free-political-wordpress-theme/','political-campaign'));
...
function political_campaign_sanitize_float( $input ) {
...
add_filter('loop_shop_columns', 'political_campaign_loop_columns');
	...
	function political_campaign_loop_columns() {
		return get_theme_mod( 'political_campaign_products_per_row', 3 );
		// 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'political_campaign_products_per_page' );
function political_campaign_products_per_page( $cols ) {
  	return  get_theme_mod( 'political_campaign_products_per_page',9);
}
