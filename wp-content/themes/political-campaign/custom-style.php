<?php
	...
	if($political_campaign_second_color != false){
		$political_campaign_custom_css .='.main-navigation .current-menu-item > a:after, .main-navigation li a:hover:after{';
			$political_campaign_custom_css .='border-bottom: 8px solid '.esc_attr($political_campaign_second_color).';';
		$political_campaign_custom_css .='}';
	}
