...
function political_campaign_customize_register( $wp_customize ) { 
	...
	$wp_customize->add_section( 'political_campaign_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/political-campaign-wordpress-theme/">GET PRO</a>','political-campaign'),
		'panel' => 'political_campaign_panel_id'
	) );
	...
	$wp_customize->add_section('political_campaign_Campaign_priciples_section',array(
		...
		'description' => __('For more options of campaign section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/political-campaign-wordpress-theme/">GET PRO</a>','political-campaign'),
		'panel' => 'political_campaign_panel_id',
	));
	...
	$wp_customize->add_section('political_campaign_footer',array(
		...
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/political-campaign-wordpress-theme/">GET PRO</a>','political-campaign'),
		'panel' => 'political_campaign_panel_id',
	));	
  ...
  //Woocommerce settings
    ...
    //Products per page
    $wp_customize->add_setting('political_campaign_products_per_page',array(
		'default'=> '9',
		'sanitize_callback'	=> 'political_campaign_sanitize_float'
	));
	$wp_customize->add_control('political_campaign_products_per_page',array(
		'label'	=> __('Products Per Page','political-campaign'),
		'description' => __('Display on shop page','political-campaign'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
    ...
    //Products per row
    $wp_customize->add_setting('political_campaign_products_per_row',array(
		'default'=> '3',
		'sanitize_callback'	=> 'political_campaign_sanitize_choices'
	));
	$wp_customize->add_control('political_campaign_products_per_row',array(
		'label'	=> __('Products Per Row','political-campaign'),
		'description' => __('Display on shop page','political-campaign'),
		'choices' => array(
            '2' => '2',
			'3' => '3',
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new Political_Campaign_Customize_Section_Pro( $manager,'political_campaign_go_pro', array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/products/political-campaign-wordpress-theme/'),
		) )	);
