...
class Politics_Candidate_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'politics-candidate'); ?>">
                        </div>
                        <?php
                        $politics_candidate_font_awesome_icon_array = politics_candidate_font_awesome_icon_array();
                        foreach ($politics_candidate_font_awesome_icon_array as $politics_candidate_font_awesome_icon) {
                              $icon_class = $this->value() == $politics_candidate_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($politics_candidate_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($politics_candidate_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function politics_candidate_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'politics_candidate_customizer_script' );

if(!function_exists('politics_candidate_font_awesome_icon_array')){
    function politics_candidate_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
